...
-- List of "ulx" rank that are allowed to use "Views options" features
-- This must look like this : {"superadmin", "seniormoderator", "dev", "admin"}
NAP_DEVTOOL.Config.AllowedRanksViewsFeatures = {"superadmin", "admin", "dev"}

NAP_DEVTOOL.Config.TracesLenght = 50000
